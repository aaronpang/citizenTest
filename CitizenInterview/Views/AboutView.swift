    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ...
                Text("This is an unofficial app used to study for the U.S. Naturalization interview. It is completely free of charge to use and is open sourced with no ads throughout the app.\n\nIt is free because I, (the developer) needed to study for the naturalization test myself and wanted to share it with others that needed to study as well.").padding()
